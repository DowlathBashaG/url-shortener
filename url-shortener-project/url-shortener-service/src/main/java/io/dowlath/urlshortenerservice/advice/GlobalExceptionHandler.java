package io.dowlath.urlshortenerservice.advice;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        problemDetail.setDetail(getValidationError(ex));
    ...
    @NotNull
    private static String getValidationError(MethodArgumentNotValidException ex) {
        return ex
                .getBindingResult()
                .getFieldErrors()
                .stream()
